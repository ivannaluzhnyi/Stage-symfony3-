...
namespace OC\QuestBundle\Controller;
...
class DefaultController extends Controller
{
   public function menuAction()
    {
        return $this->render('OCQuestBundle:Default:menu.html.twig');
    }
    ...
    {
          return $this->render('OCQuestBundle:Default:merci.html.twig');
    }
       ...
       public function listAction()
    {
                ...
                return $this->render('OCQuestBundle:Default:list.html.twig',array('listQuest'=>$listQuest));
    }
   ...
   $repository = $this
    ...
    return $this->render('OCQuestBundle:Default:admin.html.twig',array(
        'lists'=>$lists));
    }
...
$form   = $this->get('form.factory')->create(QuestionsType::class, $questions);
    ...
    // $request=$this->get('request');
     ...
     if ($request->isMethod('POST') && $form->handleRequest($request)->isValid()) {
      ...
      return $this->redirectToRoute('oc_quest_merci', array('id' => $questions->getId()));
    ...
    public function deleteAction(Questions $questions)
    {
        ...
        return $this->render('OCQuestBundle:Default:deleted.html.twig');
    }
...
$inciter1 = $repository->findByInciter(array("Devoir de baptisé"));
...
$inciter12 = $repository->findByInciter("Célébrer (eucharistie, mariage, baptême, pardon, obsèques,…)");
                ...
                return $this->render('OCQuestBundle:Default:admin_count.html.twig',array(
                    'listQuest'=>$listQuest,
